...
const ArticleRegistrationController = { index, setPassword, verifyPassword, getSizes, getImages, getCalibration, saveCalibration, getCalibrations, setActiveCalibration, deleteCalibration, saveAnnotation, getAnnotation, deleteAnnotation }

export default ArticleRegistrationController